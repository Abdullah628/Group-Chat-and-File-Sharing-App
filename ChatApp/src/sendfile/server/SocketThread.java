...
public class SocketThread implements Runnable {
    ...
    private void createConnection(String receiver, String sender, String filename) {
        try {
            ...
            } else {// Client does not exist, send back to sender that receiver cannot be found.
                main.appendMessage("[createConnection]: Client not found '" + receiver + "'");
                DataOutputStream dos = new DataOutputStream(socket.getOutputStream());
                dos.writeUTF("CMD_SENDFILEERROR " + "Client '" + receiver + "' was not found in the list, ensure that the user is online.!");
            }
        } catch (IOException e) {
                ...
                switch (CMD) {
                    ...
                    case "CMD_CHAT":
                        ...
                        try {
                            ...
                            main.appendMessage("[Message]: From " + from + " Arrive " + sendTo + " : " + msg);
                        } catch (IOException e) {
...
//                        main.appendMessage("[CMD_CHATALL]: " + chatall_content);
                    ...
                    case "CMD_SHARINGSOCKET":
                        main.appendMessage("CMD_SHARINGSOCKET : The client sets up a socket for the file sharing connection...");
                    ...
                    case "CMD_SENDFILE":
                        ...
                        if (cSock != null) { /* Exists   */
                            ...
                            try {
                                 ...
                                 */
                                main.appendMessage("CMD_SENDFILE : sending files to the client...");
                    ...
                    case "CMD_SENDFILERESPONSE":
                         ...
                         */
                        String receiver = st.nextToken(); // method to receive receiver username
                        String rMsg = ""; // method to receive error message
            ...
            /*   This is the chatting client function, remove if it exists..   */

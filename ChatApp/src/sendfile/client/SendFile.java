...
public class SendFile extends javax.swing.JFrame {
        ...
        public void run() {
            try {
                while(!Thread.currentThread().isInterrupted()){
                    String data = dis.readUTF();  // Read the content of data received from the Server
                    st = new StringTokenizer(data);
                    String cmd = st.nextToken();  //  Get the first letter from the data
                    switch(cmd){
    ...
    /*   This method will disable/enable all GUIs  */
